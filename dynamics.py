...
# Expected payoff to a player using strategy (x1, x2, 1-x1-x2) against a player using strategy (y1, y2, 1-y1-y2)
...
# Replicator dynamics for a symmetric 2-Player 3-Strategy (2P3S) game
...
# Replicator dynamics for an asymmetric 2-player 2-strategy (2P2S) game
...
# Expected payoff to a player using strategy (x1, x2, x3, 1-x1-x2-x3) against a player using strategy (y1, y2, y3, 1-y1-y2-y3)
...
# Replicator dynamics for a symmetric 2-Player 4-Strategy (2P4S) symmetric game
